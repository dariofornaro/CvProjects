...
public class CriteriaFirst_NameTest {
    ...
    public void TestMeetCriteria() {
        ...
        up1.setParameter("First Name", "Test");
        u1.setProfile(up1);
        up2.setParameter("First Name", "mmm");
        u2.setProfile(up2);
        up3.setParameter("First Name", "Test");
        u3.setProfile(up3);
        users.add(u1);
        users.add(u2);
        users.add(u3);
        Criteria<UserModel> c = new CriteriaFirst_Name();
